...
import { X, Plus, Trash2, Edit3, Check, Shield, Swords, Brain, Eye } from 'lucide-react'
...
export function CharacterSheet({ isOpen, onClose, character, onUpdate }: CharacterSheetProps) {
  const [activeSection, setActiveSection] = useState<'abilities' | 'saves' | 'skills' | 'weapons'>('abilities')
  ...
  const sections = [
    { id: 'abilities' as const, label: 'Abilities', icon: Brain },
